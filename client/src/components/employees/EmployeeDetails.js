      ...
      <Fragment>
        ...
        <div className="card grid-2">
          <div className="all-center">
            ...
            <p>GitHub Username: {current.githubusername}</p>
          </div>
            ...
            <ul>
                ...
                {current.employment_status && (
                  <Fragment>
                    <h3 className="text-left">
                      Status: <span>{current.employment_status}</span>
                    </h3>
                  </Fragment>
                )}
              </li>
              ...
              <li>
                {current.nationality && (
                  <Fragment>
                    <h3 className="text-left">
                      Nationality: <span>{current.nationality}</span>
                    </h3>
                  </Fragment>
                )}
              </li>
              <li>
                {current.gender && (
                  <Fragment>
                    <h3 className="text-left">
                      Gender: <span>{current.gender}</span>
                    </h3>
                  </Fragment>
                )}
              </li>
              <li>
                {current.education_qualification && (
                  <Fragment>
                    <h3 className="text-left">
                      Education Qualification:{' '}
                      <span>{current.education_qualification}</span>
                    </h3>
                  </Fragment>
                )}
              </li>
