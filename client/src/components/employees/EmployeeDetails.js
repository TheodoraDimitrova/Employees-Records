    ...
    return (
        ...
        <div className="card grid-2">
          <div className="all-center">
            ...
            />
            <h1>{current.name}</h1>
            <p>Phone number: {current.contact_number}</p>
          ...
          <div>
            <ul>
              <li>
                <Fragment>
                  <h3 className="text-left">
                    Employee Status: <span>{current.employment_status}</span>
                  </h3>
                </Fragment>
              </li>
              <li>
                <Fragment>
                  <h3 className="text-left">
                    Application Status:{' '}
                    <span>{current.application_status}</span>
                  </h3>
                </Fragment>
              </li>
              ...
              <li>
                <Fragment>
                  <h3 className="text-left">
                    Van registration: <span>{current.reg_number}</span>
                  </h3>
                </Fragment>
              </li>
              <li>
              ...
              <li>
                <Fragment>
                  <h3 className="text-left">
                    FD : <span>{current.fd_number}</span>
                  </h3>
                </Fragment>
              </li>
              <li>
                <Fragment>
                  <h3 className="text-left">
                    DrivingLicenceNo : <span>{current.drivingLicenceNo}</span>
                  </h3>
                </Fragment>
              </li>
              <li>
                <Fragment>
                  <h3 className="text-left">
                    DL issued in : <span>{current.dl_status}</span>
                  </h3>
                </Fragment>
              </li>
              <li>
              ...
              <li>
                <Fragment>
                  <h3 className="text-left">
                    DBS certificate : <span>{current.dbs_certificate}</span>
                  </h3>
                </Fragment>
              </li>
              <li>
              ...
              {/* <li>
                  {current.drivingLicenceNo && (
                    <Fragment>
                      <h3 className="text-left">
                        Driving Licence : <span>{current.drivingLicenceNo}</span>
                      </h3>
                    </Fragment>
                  )}
                </li> */}
